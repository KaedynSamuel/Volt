...
function CleanTaskCard({
  ...
  return (
    ...
    >
      ...
      <div className="mb-2.5 flex items-start gap-3 pr-[150px]">
                  ...
                  return (
                    ...
                    >
                      <div className="mb-2 flex items-start justify-between gap-3">
                        ...
                        <span className="shrink-0 rounded-full bg-destructive/15 px-2 py-1 text-xs font-bold text-destructive">
